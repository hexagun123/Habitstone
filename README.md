...
## Key note
Please note that when you sign in google will block the pop-up (idk why), just disable it for this site
Also please refresh for the sync to happen (will fix that soon)


## Current Features

- Create goals and track tasks.
- Carry the streak.
- Reward?
- Randomness...
- Mess around with authentication and cross platform syncing.
## Current Features
